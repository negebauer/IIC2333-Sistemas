...
bool
 cmp_thread_priority (const struct list_elem *t1, const struct list_elem *t2, void *unused UNUSED)
{
...
/* Checks if the current thread has lower priority than a new thread */
void
check_priority()
{
